 ...
 * 
 *   - Logic Layer
 *     The implementation of page logic, such as `form` register
 * 
 *   - Enhancement Layer
 *     The implementation of page animation
 * 
 ****************************************/
...
window.onload = function() {
    ...
    (function() {
        ...
        EventUtil.addHandler(getValMsgBtn, 'click', function() {
            ...
            sessionStorage.setItem('valCode', jsonObj.responseText);
        });
        // ensure validate message
        var uVMsg = document.getElementById('upValMsg');
        EventUtil.addHandler(uVMsg, 'blur', function() {
            var validcode = sessionStorage.getItem('valCode');
            if (valicode === this.value) {
                addClass(this, 'validationStyle-successed');
            } else {
                addClass(this, 'validationStyle-failed');
    ...
    (function() {
        ...
        EventUtil.addHandler(psdVis, 'mousedown', function(e) {
            e.stopPropagation();
            removeClass(this, 'fa-eye-slash');
            addClass(this, 'fa-eye');
            pswd.type = 'text';
        });
        EventUtil.addHandler(psdVis, 'mouseup', function(e) {
            e.stopPropagation();
            removeClass(this, 'fa-eye');
            addClass(this, 'fa-eye-slash');
            pswd.type = 'password';
        ...
        EventUtil.addHandler(oClose, 'click', function(e) {

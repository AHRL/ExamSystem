...
/**
 * Created by xiongxiaoyu on 2017/11/28.
 */
public class QQAuthenticationFilter extends AbstractAuthenticationProcessingFilter{
     ...
     * client_id 由腾讯提供
     */
    static final String clientId = "101445154";
//    static final String clientId = "101386962";

    /**
     * client_secret 由腾讯提供
     */
    private final static String clientSecret = "741acb9ae6ad85ae15a00a259f3c51b8";
    //private final static String clientSecret = "2a0f820407df400b84a854d054be8b6a";

    /**
     * redirect_uri 腾讯回调地址
     */
    private final static String redirectUri = "http://fun.swpuiot.com/login/qq";
